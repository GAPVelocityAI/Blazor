...
namespace SKS
{
   ...
   public partial class frmReceptionApproval
      : Gap.Blazor.Form
   {
      ...
      : base()
      {
         this.View = typeof(FrmReceptionApprovalView);
      ...
      private void cmbStatus_SelectedIndexChanged(Object eventSender, EventArgs eventArgs) => DoSearchReception();

      private void cmdApprove_Click(Object eventSender, EventArgs eventArgs) => LoadActionOrderReception(1);

      private void cmdCancel_Click(Object eventSender, EventArgs eventArgs) => LoadActionOrderReception(2);

      private void cmdInfo_Click(Object eventSender, EventArgs eventArgs) => LoadActionOrderReception();
      ...
      {
         chkFrom.CheckState = Gap.Blazor.CheckState.Checked;
         DoSearchReception();
      }

      private void dtTo_ValueChanged(Object eventSender, EventArgs eventArgs)
      {
         chkTo.CheckState = Gap.Blazor.CheckState.Checked;
         DoSearchReception();
      }
      ...
      private void txtOrderID_TextChanged(Object eventSender, EventArgs eventArgs) => DoSearchReception();

      private void txtProductID_TextChanged(Object eventSender, EventArgs eventArgs) => DoSearchReception();

      private void txtProviderName_TextChanged(Object eventSender, EventArgs eventArgs) => DoSearchReception();

      private void txtContactLastName_TextChanged(Object eventSender, EventArgs eventArgs) => DoSearchReception();

      private void txtContactName_TextChanged(Object eventSender, EventArgs eventArgs) => DoSearchReception();
      ...
      //private void txtName_Change() => DoSearchReception();
      //
      ...
      private void DoSearchReception(int Id = -1)
      {
         ...
         if ( chkFrom.CheckState == Gap.Blazor.CheckState.Checked )
         {
            modFunctions.AppendAND(ref filter);
         ...
         if ( chkTo.CheckState == Gap.Blazor.CheckState.Checked )
         {
            modFunctions.AppendAND(ref filter);
