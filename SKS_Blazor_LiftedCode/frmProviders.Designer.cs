...
#region "Windows Form Designer generated code "
      ...
      private void InitializeComponent()
      {
         ...
         dcProviders.Properties().BackColor = Gap.Blazor.SystemColors.Window;
         dcProviders.Properties().BOFAction = UpgradeHelpers.DB.BOFActionEnum.MoveFirst;
         ...
         dcProviders.Properties().EOFAction = UpgradeHelpers.DB.EOFActionEnum.MoveLast;
         dcProviders.FactoryName = "Access";
         dcProviders.Properties().Font = new Gap.Blazor.Font("Microsoft Sans Serif", 8.25f, Gap.Blazor.FontStyle.Regular, Gap.Blazor.GraphicsUnit.Point, 0);
         dcProviders.Properties().ForeColor = Gap.Blazor.SystemColors.WindowText;
...
#region "Upgrade Support"
      ...
      {
         dcProviders.Refresh();
         _txtField_9.DataBindings.Add("Text", dcProviders, "Extension", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_14.DataBindings.Add("Text", dcProviders, "Notes", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_10.DataBindings.Add("Text", dcProviders, "FaxNumber", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_8.DataBindings.Add("Text", dcProviders, "PhoneNumber", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_12.DataBindings.Add("Text", dcProviders, "ContactFirstName", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_13.DataBindings.Add("Text", dcProviders, "ContactLastName", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_11.DataBindings.Add("Text", dcProviders, "ContactTitle", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_5.DataBindings.Add("Text", dcProviders, "City", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_2.DataBindings.Add("Text", dcProviders, "EmailAddress", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_7.DataBindings.Add("Text", dcProviders, "Country/Region", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_6.DataBindings.Add("Text", dcProviders, "StateOrProvince", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_0.DataBindings.Add("Text", dcProviders, "ProviderName", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_4.DataBindings.Add("Text", dcProviders, "PostalCode", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_1.DataBindings.Add("Text", dcProviders, "PaymentTerms", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
      }
#endregion
