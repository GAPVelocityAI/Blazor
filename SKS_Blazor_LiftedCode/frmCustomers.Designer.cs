...
#region "Upgrade Support "
      private static frmCustomers m_vb6FormDefInstance
      {
         get
         {
            return StaticService.Get<frmCustomers>($"{typeof(frmCustomers).FullName}.m_vb6FormDefInstance");
         }
         set
         {
            StaticService.Set($"{typeof(frmCustomers).FullName}.m_vb6FormDefInstance", value);
         }
      }
      ...
      private static bool m_InitializingDefInstance
      {
         get
         {
            return StaticService.Get<bool>($"{typeof(frmCustomers).FullName}.m_InitializingDefInstance");
         }
         set
         {
            StaticService.Set($"{typeof(frmCustomers).FullName}.m_InitializingDefInstance", value);
         }
      }
...
#region "Windows Form Designer generated code "
      ...
      public Gap.Blazor.VBUC.ADODataControlHelper dcCustomers { get; set; }
      ...
      private void InitializeComponent()
      {
         ...
         dcCustomers.Properties().BackColor = Gap.Blazor.SystemColors.Window;
         dcCustomers.Properties().BOFAction = UpgradeHelpers.DB.BOFActionEnum.BOF;
         ...
         dcCustomers.Properties().EOFAction = UpgradeHelpers.DB.EOFActionEnum.MoveLast;
         dcCustomers.FactoryName = "Access";
         dcCustomers.Properties().Font = new Gap.Blazor.Font("Microsoft Sans Serif", 8.25f, Gap.Blazor.FontStyle.Regular, Gap.Blazor.GraphicsUnit.Point, 0);
         dcCustomers.Properties().ForeColor = Gap.Blazor.SystemColors.WindowText;
         ...
         ImageList1.ImageStream = new ImageList.ImageListStreamer(ImageList1, "SKS.frmCustomers.ImageList1.ImageStream");
...
#region "Upgrade Support"
      ...
      {
         dcCustomers.Refresh();
         _txtField_9.DataBindings.Add("Text", dcCustomers, "Extension", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_14.DataBindings.Add("Text", dcCustomers, "Notes", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_10.DataBindings.Add("Text", dcCustomers, "FaxNumber", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_8.DataBindings.Add("Text", dcCustomers, "PhoneNumber", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_12.DataBindings.Add("Text", dcCustomers, "ContactFirstName", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_13.DataBindings.Add("Text", dcCustomers, "ContactLastName", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_11.DataBindings.Add("Text", dcCustomers, "ContactTitle", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_5.DataBindings.Add("Text", dcCustomers, "City", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_3.DataBindings.Add("Text", dcCustomers, "BillingAddress", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_1.DataBindings.Add("Text", dcCustomers, "CompanyOrDepartment", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_2.DataBindings.Add("Text", dcCustomers, "EmailAddress", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_7.DataBindings.Add("Text", dcCustomers, "Country/Region", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_6.DataBindings.Add("Text", dcCustomers, "StateOrProvince", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_0.DataBindings.Add("Text", dcCustomers, "CompanyName", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
         _txtField_4.DataBindings.Add("Text", dcCustomers, "PostalCode", false, Gap.Blazor.DataSourceUpdateMode.OnPropertyChanged);
      }
#endregion
