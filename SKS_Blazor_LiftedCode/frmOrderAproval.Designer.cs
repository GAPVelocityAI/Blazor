...
#region "Upgrade Support "
      private static frmReceptionApproval m_vb6FormDefInstance
      {
         get
         {
            return StaticService.Get<frmReceptionApproval>($"{typeof(frmReceptionApproval).FullName}.m_vb6FormDefInstance");
         }
         set
         {
            StaticService.Set($"{typeof(frmReceptionApproval).FullName}.m_vb6FormDefInstance", value);
         }
      }
      ...
      private static bool m_InitializingDefInstance
      {
         get
         {
            return StaticService.Get<bool>($"{typeof(frmReceptionApproval).FullName}.m_InitializingDefInstance");
         }
         set
         {
            StaticService.Set($"{typeof(frmReceptionApproval).FullName}.m_InitializingDefInstance", value);
         }
      }
