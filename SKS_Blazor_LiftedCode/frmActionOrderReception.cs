...
namespace SKS
{
   ...
   public partial class frmActionOrderReception
      : Gap.Blazor.Form
   {
      ...
      : base()
      {
         this.View = typeof(FrmActionOrderReceptionView);
      ...
      private void cmdApprove_Click(Object eventSender, EventArgs eventArgs)
      {
         try
         {
            ...
            LoadData();
            Application.CurrentApplication.ShowSimpleNotification("The order was successfully approved", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
            this.Close();
         }
      ...
      private async Task cmdCancel_Click(Object eventSender, EventArgs eventArgs)
      {
         try
         {
            if ( txtStatus.Text.ToUpper() == "CANCELLED" )
            ...
            if ( await Gap.Blazor.MessageBox.Show("Do you want to cancel the order reception?", "Confirm cancellation", Gap.Blazor.MessageBoxButtons.YesNo, Gap.Blazor.MessageBoxIcon.Question) != Gap.Blazor.DialogResult.Yes )
            {
               return ;
            }
            // UPDATE
            ...
            LoadData();
            Application.CurrentApplication.ShowSimpleNotification("The order was successfully cancelled", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
            this.Close();
         }
         catch( System.Exception excep )
         {
         ...
         if ( Action != 0 )
         {
            switch ( (Action) )
            {
               case 1:
                  ...
                  break;
               case 2:
                  await cmdCancel_Click(cmdCancel, new EventArgs());
                  break;
            }
         }
      }
