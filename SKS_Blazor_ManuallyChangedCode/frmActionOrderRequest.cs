...
namespace SKS
{
   ...
   public partial class frmActionOrderRequest
      : Gap.Blazor.Form
   {
      ...
      : base()
      {
         this.View = typeof(FrmActionOrderRequestView);
      ...
      private async Task cmdCancel_Click(Object eventSender, EventArgs eventArgs)
      {
         try
         {
            ...
            if ( await Gap.Blazor.MessageBox.Show("Do you want to cancel the order request?", "Confirm cancellation", Gap.Blazor.MessageBoxButtons.YesNo, Gap.Blazor.MessageBoxIcon.Question) != Gap.Blazor.DialogResult.Yes )
            {
               return ;
            }
            // UPDATE
